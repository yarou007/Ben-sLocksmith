(function () {
  ...
  function ensureRequestServiceFormSection() {
    ...
    section.innerHTML =
      ...
      CONFIG.phoneLabel +
      '</a>.</p>' +
      '<form class="quote-form request-service-form" id="request-service-form" action="https://formsubmit.co/Info@capitalglassdoor.com" method="POST" style="display:grid;gap:10px">' +
